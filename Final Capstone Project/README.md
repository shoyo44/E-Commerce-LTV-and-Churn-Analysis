...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Dhanush S </p>
    <p><strong>Email ID:</strong> dhanush4102005@gmail.com </p>
    <p><strong>College Name:</strong> Kalasalingam Academy of Research and Education </p>
    <p><strong>Branch/Specialization :</strong> CSE(AIML </p>
    <p><strong>College ID:</strong> 99230041087@klu.ac.in </p>
</div>
...
<p><strong>Trainer Designation:</strong> Software Engineer(PowerBI)</p>
...
## Overall Learning 
During this course I have learned to understand the core concepts of PowerBI and visualizations.This course also enriches me in concepts of DAX fucntions.I have also learned to manipulate the data to structurize the dashboard.


<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Capstone Project:</a></strong> &lt;E Commerce LTv and Churn Analysis&gt;</p>
...
<!-- Project 1 -->
<h3 id="project1">Capstone Project: E Commerce LTV and Churn Analysis</h3>
<p>
This project involves in  creating a dashboard for representing the life time value of the customer and the churn analysis of the company.It also gives insights on discount impact,retention analysis,cohort analysis.
</p>
